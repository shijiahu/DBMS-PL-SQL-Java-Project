drop trigger trig_insert_customers;
drop trigger trig_update_visit;
drop trigger trig_insert_purchases;
drop trigger trig_update_qoh;
drop trigger trig_insert_supplies;
drop trigger after_insert_pur;
drop trigger delete_pur;
...
insert into purchases values (100001, 'e01', 'p002', 'c001', 1, to_date('12-AUG-2017 10:34:30', 'DD-MON-YYYY 
HH24:MI:SS'), 211.65);
insert into purchases values (100002, 'e01', 'p003', 'c001', 1, to_date('20-SEP-2017 11:23:36', 'DD-MON-YYYY 
HH24:MI:SS'), 118.40);
insert into purchases values (100003, 'e02', 'p004', 'c002', 5, to_date('08-OCT-2017 09:30:50', 'DD-MON-YYYY 
HH24:MI:SS'), 4.95);
insert into purchases values (100004, 'e01', 'p005', 'c003', 2, to_date('23-AUG-2017 16:23:35', 'DD-MON-YYYY 
HH24:MI:SS'), 18.17);
insert into purchases values (100005, 'e04', 'p007', 'c004', 1, to_date('15-OCT-2017 13:38:55', 'DD-MON-YYYY 
HH24:MI:SS'), 119.20);
insert into purchases values (100006, 'e03', 'p008', 'c001', 1, to_date('12-OCT-2017 15:22:10', 'DD-MON-YYYY 
HH24:MI:SS'), 349.30);
insert into purchases values (100007, 'e03', 'p006', 'c003', 2, to_date('10-SEP-2017 17:12:20', 'DD-MON-YYYY 
HH24:MI:SS'), 35.91);
insert into purchases values (100008, 'e03', 'p006', 'c005', 1, to_date('16-AUG-2017 12:22:15', 'DD-MON-YYYY 
HH24:MI:SS'), 17.96);
insert into purchases values (100009, 'e03', 'p001', 'c007', 1, to_date('12-OCT-2017 14:44:23', 'DD-MON-YYYY 
HH24:MI:SS'), 8.99);
insert into purchases values (100010, 'e04', 'p002', 'c006', 1, to_date('19-SEP-2017 17:32:37', 'DD-MON-YYYY 
HH24:MI:SS'), 211.65);
insert into purchases values (100011, 'e02', 'p004', 'c006', 10, to_date('16-OCT-2017 16:54:40', 'DD-MON-YYYY 
HH24:MI:SS'), 9.90);
insert into purchases values (100012, 'e02', 'p008', 'c003', 2, to_date('18-SEP-2017 15:56:38', 'DD-MON-YYYY 
HH24:MI:SS'), 698.60);
insert into purchases values (100013, 'e04', 'p006', 'c005', 2, to_date('30-AUG-2017 10:38:25', 'DD-MON-YYYY 
HH24:MI:SS'), 35.91);
insert into purchases values (100014, 'e03', 'p009', 'c008', 3, to_date('14-OCT-2017 10:54:06', 'DD-MON-YYYY 
HH24:MI:SS'), 134.84);
...
begin
	...
	insert into logs values(log_seq.NEXTVAL, v_username, 'insert', v_time, 'customers', :new.cid);
	dbms_output.put_line('Record successfully inserted into logs table.');
end;
/
show errors


create or replace trigger trig_update_visit
...
begin
	select user into v_username from dual;
	select sysdate into v_time from dual;
	insert into logs values(log_seq.NEXTVAL, v_username, 'update', v_time, 'customers', :new.cid);
	dbms_output.put_line('Record successfully inserted into logs table.');
end;
/
show errors
...
create or replace trigger trig_insert_purchases
...
begin
	select user into v_username from dual;
	select sysdate into v_time from dual;
	insert into logs values(log_seq.NEXTVAL, v_username, 'insert', v_time, 'purchases', :new.pur#);
	dbms_output.put_line('Record successfully inserted into logs table.');
end;
/
show errors
...
begin
	select user into v_username from dual;
	select sysdate into v_time from dual;
	insert into logs values(log_seq.NEXTVAL, v_username, 'update', v_time, 'products', :new.pid);
	dbms_output.put_line('Record successfully inserted into logs table.');
end;
/
show errors
...
create or replace trigger trig_insert_supplies
...
begin
	select user into v_username from dual;
	select sysdate into v_time from dual;
	insert into logs values(log_seq.NEXTVAL, v_username, 'insert', v_time, 'supplies', :new.sup#);
	dbms_output.put_line('Record successfully inserted into logs table.');
end;
/
show errors
...
create or replace trigger after_insert_pur
after insert on purchases
for each row
...
next_pur_no NUMBER;
next_sup_no NUMBER;
temp_sid supplies.sid%type;
temp_qty supplies.quantity%type;
new_qty supplies.quantity%type;
temp_qoh products.qoh%type;
temp_qoh_threshold products.qoh_threshold%type;

begin
	update products set qoh = qoh - :new.qty where pid = :new.pid;
	select qoh, qoh_threshold into temp_qoh, temp_qoh_threshold from products where pid = :new.pid;
	...
	if (temp_qoh < temp_qoh_threshold) then
		...
		select pur_seq.CURRVAL into next_pur_no from dual;
		select sup_seq.NEXTVAL into next_sup_no from dual;
		select min(sid) into temp_sid from supplies where pid = :new.pid;
		select (qoh_threshold - qoh + 1) + qoh + 10 into new_qty from products where pid = :new.pid;

		insert into supplies values(next_sup_no, :new.pid, temp_sid, sysdate, new_qty);
		update products set qoh = qoh + new_qty where pid = :new.pid;
...
create or replace trigger delete_pur
