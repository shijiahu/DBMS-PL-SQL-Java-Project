...
public class C_show_supplies {
	public static String supplies () throws SQLException {
		String result = "";
	    try
	    {
		...
		String password = "qc476404667";
	        ...
	        CallableStatement cs = conn.prepareCall("begin ? := proj2_v1.show_supplies(); end;");
	        ...
	        result = result + "sup#"+"\t"+"pid"+"\t"+"sid"+"\t"+"sdate"+"\t\t"+"quantity"+"\n";
	        // print the results
	        while (rs.next()) {
