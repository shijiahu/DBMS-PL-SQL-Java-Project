...
public class C_show_suppliers {
	public static String suppliers () throws SQLException {
		String result = "";
	    try
	    {
		...
		String password = "qc476404667";
	        ...
	        CallableStatement cs = conn.prepareCall("begin ? := proj2_v1.show_suppliers(); end;");
	        ...
	        result = result+"sid"+"\t"+"name"+"\t"+"city"+"\t"+"telephone#"+"\t"+"email"+"\n";
	        // print the results
	        while (rs.next()) {
