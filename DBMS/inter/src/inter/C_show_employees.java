...
public class C_show_employees {
	public static String employees () throws SQLException {
		String result="";
	    try
	    {
		...
		String password = "qc476404667";
	        ...
	        CallableStatement cs = conn.prepareCall("begin ? := proj2_v1.show_employees(); end;");
	        ...
	        result = result + "eid" + "\t" + "name" +"\t"+"telephone#"+"\t\t"+"email"+"\n";
	        // print the results
	        while (rs.next()) {
